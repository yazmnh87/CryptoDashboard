...
class UserProfile extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="UserProfile" style={{ borderRight: "solid white", height: "100vh", paddingTop: 20, marginRight: -20, marginTop: -50 }}>
                <Ticker />
                ...
                <img style={{ width: 150, height: 150, display: 'block', margin: "auto", marginTop: 30 }} alt="" src={this.props.currentCoin && this.props.currentCoin === "BTC" ? "https://en.bitcoin.it/w/images/en/2/29/BC_Logo_.png" : this.props.currentCoin && this.props.currentCoin === "ETH" ? "https://1000logos.net/wp-content/uploads/2018/04/Ethereum-Logo.png" : this.props.currentCoin && this.props.currentCoin === "LTC" ? "https://cdn4.iconfinder.com/data/icons/cryptocoins/227/LTC-512.png" : this.props.currentCoin && this.props.currentCoin === "EOS" ? "https://cdn.iconscout.com/icon/free/png-256/eos-9-646062.png" : this.props.currentCoin && this.props.currentCoin === "XRP" ? "https://cdn.freebiesupply.com/logos/large/2x/ripple-2-logo-png-transparent.png" : null} />
