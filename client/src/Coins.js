    ...
    render() {
        ...
        return (
            ...
            <div style={{display: "grid", gridGap: 15, gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr)", marginLeft:"5%", marginRight:"4.5%", marginTop:15}}>
                <h2 style={{width:"99%",borderBottom: "solid white"}}>Day Open: <p style={{display:"inline-block", color:"yellow"}}>{this.props.currentCoin && this.props.currentCoin === "BTC" ? this.props.coinOpen : this.props.currentCoin && this.props.currentCoin === "ETH" ? this.props.coinOpen : this.props.currentCoin && this.props.currentCoin === "LTC" ? this.props.coinOpen : this.props.currentCoin && this.props.currentCoin === "XRP" ? this.props.coinOpen : this.props.currentCoin && this.props.currentCoin === "EOS" ? this.props.coinOpen : this.props.coinOpen} </p></h2>
                <h2 style={{width:"99%",borderBottom: "solid white"}}>Total Volume: <p style={{display:"inline-block", color:"yellow"}}>{this.props.coinVolume}</p></h2>
